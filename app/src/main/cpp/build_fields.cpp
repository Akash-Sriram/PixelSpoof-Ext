...
// JNI: Java_com_pixelspoof_ext_DeviceSpoofer_00024BuildFieldNative_nativeSetStatic
extern "C" JNIEXPORT jboolean JNICALL
Java_com_pixelspoof_ext_DeviceSpoofer_00024BuildFieldNative_nativeSetStatic(
        JNIEnv* env,
        jclass /*clazz*/,
        jclass targetClass,
        jstring fieldName,
